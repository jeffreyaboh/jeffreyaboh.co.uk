...
$stname= $n['s_name'];
$id=$_SESSION['user'];
$q=mysqli_query($con,"select s_pay from t_user where s_id='$getid'");
$n=  mysqli_fetch_assoc($q);
$pay= $n['s_pay'];
$id=$_SESSION['user'];
$q=mysqli_query($con,"select m_occ from t_user where s_id='$getid'");
$n=  mysqli_fetch_assoc($q);
$srank= $n['m_occ'];
$id=$_SESSION['user'];
...
programme leading to the award of <font style="font-family: Verdana; font-weight: bold; font-size: 16px;"><?php echo $srank;?></font>  for a period 
of <b><?php echo $pay;?></b>.
            </p>
