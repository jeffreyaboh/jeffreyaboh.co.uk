...
if(isset($_REQUEST["admcreate"]))
{
    ...
    echo "<b>NOTE:</b> New Administrator Added Successfully! <br> <br>Admin ID is:  ".$txtid;
    echo "<br>Admin Password is:  " .$txtpwd;
...
?>
      <form id="admin" action="admin.php" method="post">
            ...
            <div class="row">
                    <div class="col-sm-12">
                    <?php echo "<b>Welcome, $adname</b>"?> 
                        <font style="color:white; margin-left:110px; font-family: Verdana; width:100%; font-size:30px;">
                         <b>ADEWALE IBRAHIM COLLEGE OF HEALTH SCIENCES</b></font>
                      </div>
                 </div>
             </div>
		...
		while($ar = mysqli_fetch_array($rs1))
               ...
               echo "<td><a target=\"_blank\" href='viewform.php?id=".$ar[0]."'>" . $ar[0] . "</a></td>";
                echo "<td>" . $ar[3] . "</td>";
                echo "<td>" . $ar[2] . "</td>";
                echo "<td>" . $ar[4] . "</td>";
                echo "<td>" . $ar[5] . "</td>";
                echo "<td>" . $ar[6] . "</td>";
                 ...
                 echo "<td> <a target=\"_blank\"  href='adminac.php?id=".$ar[0]."' >
                     <input type='button' value='Admission Letter'  class='toggle btn btn-primary'> </a></td>";
              

                     echo "<td> <a target=\"_blank\"  href='viewdoc.php?id=".$ar[0]."' >
                     <input type='button' value='View Documents' class='toggle btn btn-primary'> </a></td>";

                     echo "<td> <a target=\"_blank\"  href='#' >
                     <input type='button' value='Change Programme'  class='toggle btn btn-primary'> </a></td>";
                
               // echo "<td><a href='appr.php?id=".$ar[0]."'> <button class='add_field_button'  style='background-color:transparent;border:none;' 
                  // name='appr' id='appr' >
                       ...
                       <div class="container">
                        ...
                        <div class="row">
                                <div class="col-sm-12"> 
                                            ...
                                            <br><b>NOTE:</b> Administrator Login ID and Password would be Automatically Generated.
                                            <hr><hr>                          
